    ...
    <Media>
        ...
        <Media body>
            ...
            <div className="d-flex mt-2">
                ...
                <Button color="link" onClick={() => {  }}  className="ml-2 text-success">
                    Cancel
                </Button>
            </div>
        </Media>
    ...
    <Media>
        ...
        <Media body>
            ...
            <div className="d-flex mt-2">
                ...
                <Button color="link" onClick={() => {  }}  className="ml-2 text-primary">
                    Cancel
                </Button>
            </div>
        </Media>
...
const contentWarning = ({  }) => (
    <Media>
        ...
        <Media body>
            ...
            <div className="d-flex mt-2">
                <Button color="warning" onClick={() => {  }} className="text-white">
                    I Understand
                </Button>
                <Button color="link" onClick={() => {  }}  className="ml-2 text-warning">
                    Cancel
                </Button>
            </div>
        </Media>
...
const contentDefault = ({  }) => (
    <Media>
        ...
        <Media body>
            ...
            <div className="d-flex mt-2">
                <Button color="secondary" onClick={() => {  }} className="text-white">
                    I Understand
                </Button>
                <Button color="link" onClick={() => {  }}  className="ml-2 text-secondary">
                    Cancel
                </Button>
            </div>
        </Media>
